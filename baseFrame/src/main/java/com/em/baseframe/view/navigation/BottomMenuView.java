...
public class BottomMenuView extends LinearLayout {
    ...
    private CustomViewPagerN mViewPager;
    ...
    public CustomViewPagerN getViewPager() {
        return mViewPager;
    }
    ...
    private void initData() {
        ...
        mViewPager = (CustomViewPagerN) findViewById(R.id.view_pager);
        ...
        mGroup.setBackgroundColor(Color.parseColor("#ebf0f3"));
    ...
    private RadioButton getRadioButton(List<Drawable> drawables, int color, List<String> menus, int i) {
        ...
        button.setBackgroundColor(Color.parseColor("#ebf0f3"));
        Bitmap a = null;
